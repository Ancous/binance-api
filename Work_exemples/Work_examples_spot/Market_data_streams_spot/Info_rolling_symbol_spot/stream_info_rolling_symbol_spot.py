...
async def func_main_stream(futures_client, list_data, symbol_winsizes):
    """
    pass
    """
    task_1 = asyncio.create_task(futures_client.get_stream_info_rolling_symbol_spot(
        list_data=list_data,
        symbol_winsizes=symbol_winsizes)
    )
