...
async def get_stream_best_price_quantity_symbol_spot(list_data: list,
...
if __name__ in "__main__":
    ...
    asyncio.run(get_stream_best_price_quantity_symbol_spot(list_data=[], symbol=data_streams))
