...
async def func_main_stream(futures_client, list_data, winsizes):
    """
    pass
    """
    task_1 = asyncio.create_task(futures_client.get_stream_info_rolling_all_spot(
        list_data=list_data,
        winsizes=winsizes)
    )
