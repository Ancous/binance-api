...
async def func_main_stream(futures_client, list_data, symbol_contract_interval):
    """
    pass
    """
    task_1 = asyncio.create_task(futures_client.get_stream_candles_contract_futures(
        list_data=list_data,
