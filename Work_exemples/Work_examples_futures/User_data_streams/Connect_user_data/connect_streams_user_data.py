...
async def func_main_user_data_stream(futures_client, dict_data, listen_key):
    """
    pass
    """
    task_1 = asyncio.create_task(futures_client.connect_user_data_streams(
        dict_data=dict_data,
...
if __name__ in "__main__":
    ...
    response = client_uds.start_user_data_stream()
    my_listen_key = response["result"]["listenKey"]

    asyncio.run(func_main_user_data_stream(
