...
async def get_stream_min_info_day_symbol_spot(self: object,
                                              list_data: list,
    ...
    while True:
        try:
            ...
            print("Стрим по минимальной информации об определенном символе спота за 24 часа разрыв соединения. Восстанавливаем.\n"
...
if __name__ in "__main__":
    ...
    asyncio.run(get_stream_min_info_day_symbol_spot(list_data=[], symbol=data_streams))
