...
def post_multiple_profit_limit(data_list: list[list[str, ...], ...],
    ...
    - возможные варианты записи data_list:  [[<"ADAUSDT">, <"BUY", "SELL">, <"14.0">, <"0.3896">, <"0.4890">, <"BOTH", "LONG", "SHORT">, <"TAKE_PROFIT">, <"GTC", "IOC", "FOK", "GTD", "GTX">, <"2312">, <"CONTRACT_PRICE", "MARK_PRICE">, <"FALSE", "TRUE">, <"ACK", "RESULT", "FULL">], ...]
