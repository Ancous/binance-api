...
def post_multiple_profit_market(data_list: list[list[str, ...], ...],
                                time_stamp: str,
    ...
    - возможные варианты записи data_list:  [[<"ADAUSDT">, <"BUY", "SELL">, <"14.0">, <"0.4890">, <"BOTH", "LONG", "SHORT">, <"TAKE_PROFIT_MARKET">, <"GTC", "IOC", "FOK", "GTD", "GTX">, <"FALSE", "TRUE">, <"2312">, <"FALSE", "TRUE">, <"CONTRACT_PRICE", "MARK_PRICE">, <"FALSE", "TRUE">, <"ACK", "RESULT", "FULL">], ...]
...
if __name__ in "__main__":
    ...
    trades_parameters = [
        ["ADAUSDT", "BUY", "14.0", "0.3090", "BOTH", "TAKE_PROFIT_MARKET", "GTC", "FALSE", str(randint(1, 100000)), "FALSE", "CONTRACT_PRICE", "FALSE", "RESULT"],
        ["ADAUSDT", "BUY", "32.0", "0.3090", "BOTH", "TAKE_PROFIT_MARKET", "GTC", "FALSE", str(randint(1, 100000)), "FALSE", "CONTRACT_PRICE", "FALSE", "RESULT"],
        ["ADAUSDT", "BUY", "16.0", "0.3090", "BOTH", "TAKE_PROFIT_MARKET", "GTC", "FALSE", str(randint(1, 100000)), "FALSE", "CONTRACT_PRICE", "FALSE", "RESULT"],
        ["ADAUSDT", "BUY", "17.0", "0.3090", "BOTH", "TAKE_PROFIT_MARKET", "GTC", "FALSE", str(randint(1, 100000)), "FALSE", "CONTRACT_PRICE", "FALSE", "RESULT"],
        ["ADAUSDT", "BUY", "20.0", "0.3090", "BOTH", "TAKE_PROFIT_MARKET", "GTC", "FALSE", str(randint(1, 100000)), "FALSE", "CONTRACT_PRICE", "FALSE", "RESULT"]
    ]

    post_multiple_profit_market(data_list=trades_parameters, time_stamp=str(round(time.time() * 1000)))
