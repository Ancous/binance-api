...
def post_profit_limit(symbol: str,
                      side: str,
                      quantity: str,
                      price: str,
                      stop_price: str,
    ...
    - если "side" == "BUY", то "stopPrice" должен быть больше "price" и меньше end_point /fapi/v1/ticker/price float(["price"])
    - если "side" == "SELL", то "stopPrice" должен быть меньше "price" и больше end_point /fapi/v1/ticker/price float(["price"])
...
if __name__ in "__main__":
    ...
    post_profit_limit(symbol="ADAUSDT", side="BUY", quantity="15.0", price="0.2000", stop_price="0.3000", time_stamp=str(round(time.time() * 1000)))
