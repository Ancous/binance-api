...
def post_trailing_stop_market(symbol: str,
                              side: str,
                              quantity: str,
...
if __name__ in "__main__":
    ...
    post_trailing_stop_market(symbol="ADAUSDT", side="BUY", quantity="14.0", callback_rate="0.1", activation_price="0.3545", time_stamp=str(round(time.time() * 1000)))
